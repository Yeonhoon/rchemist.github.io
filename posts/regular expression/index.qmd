---
title: "정규표현식을 활용한 문자 추출"
date: "2023-02-23"
keywords: ["R","regex","stringr"]
---
...
저 문자열 속에서 location, age, year, sales 를 나눠 데이터프레임으로 만들어주려면 (~~일일이 복붙하면서 데이터프레임으로 선언하는 노가다를 해야 합니다)~~ 정규표현식을 사용해야 합니다.
