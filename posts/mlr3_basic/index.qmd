...
::: callout-tip
mlr3에서 기본적으로 제공하는 태스크 이외에, [Openml.org](https://openml.org)[^1] [@vanschoren2014] , `mlr3oml` 을 통해 수많은 데이터셋을 이용할 수 있습니다.
:::

[^1]: [https://openml.org](https://openml.org/)

```{r eval=FALSE}
library(mlr3oml)
mlr3oml::list_oml_data()
```
