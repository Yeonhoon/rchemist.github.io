---
title: 'mlr3: 교차검증'
description: "resampling 이용한 cross validation"
date: "2023-02-24"
...
rr <- resample(task, learner, resample)
rr
```
...
다음으로는 \$aggregate()를 이용해 모델의 성능을 살펴보겠습니다. `$aggregate()`는 반복 때마다 계산된 성능의 평균 값을 꼐산하여 출력합니다.
