...
<img src="http://www.datasmith.org/wp-content/uploads/2020/05/cran-alluvial-example.png" alt="alluvial"/>

<img src="http://www.datasmith.org/wp-content/uploads/2020/05/d3-sankey-classic-example-1536x800.png" alt="sankey"/>
...
ICU에 입원한 환자들의 일자별 AKI 상태의 변화를 시각화하는 그래프입니다.
```{r}
library(alluvial)
